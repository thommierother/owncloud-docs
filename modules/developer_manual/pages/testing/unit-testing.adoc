...
:encryption-app-url: https://github.com/owncloud/encryption
...
. Change into the apps directory, in the root directory of your ownCloud installation
. Then change into the directory of the app that you want to test. 
...
Here's an example of running the command in {encryption-app-url}[the encryption app]:
...
Runtime:       PHP 7.2.19-0ubuntu0.19.04.2
Configuration: /var/www/owncloud-community/apps/encryption/phpunit.xml
...
Time: 29.21 seconds, Memory: 32.00MB

OK (251 tests, 724 assertions)
----
--
...
[NOTE] 
====
Apps that are part of core *do not* have their own Makefile; these apps are: 
